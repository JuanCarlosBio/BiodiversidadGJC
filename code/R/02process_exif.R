...
## -> 24/11/2024, bueno mejorando, pero quedan cosas que limpiar, quiero quitar algún
## campo más
...
rp_species <- read_and_processed_species_spatial <- function(path, id_specie_start){
...
rp_species(
    path="data/species/raw/raw_dropbox_links_metazoa_content.tsv", id_specie_start="^AI"
    ) |> readr::write_tsv("data/species/processed/coord_invertebrates.tsv") 

rp_species(path="data/species/raw/raw_dropbox_links_plantae_content.tsv", id_specie_start="^FV") |>
