...
- Para obtener ayuda sobre funcionamiento las opciones más importantes del mapa interactivo, se puede consultar la [documentación](`r rmarkdown::metadata$documentation`).
